...
class ProfileSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = ['username', 'first_name', 'last_name', 'full_name', 'email', 'id', 'phone_number',
                  'profile_photo', 'about_me', 'license', 'gender', 'country', 'city', 'is_buyer', 'is_seller',
                  'agent', 'num_reviews', 'reviews']
...
class UpdateProfileSerializer(serializers.ModelSerializer):
    ...
    def to_representation(self, instance):
        representation = super(UpdateProfileSerializer, self).to_representation(instance)
        if instance.top_agent:
            representation['top_agent'] = True
        return representation
