...
class CustomeUserManager(BaseUserManager):
    ...
    def email_validator(self, email):
        try:
            ...
            raise ValueError(_("Please Provide Valid Email"))
    ...
    def create_superuser(self, username, first_name, last_name, email, password, **extra_fields):
        ...
        if extra_fields.get('is_staff') is not True:
            raise ValueError(_('Superuser must me is_staff==True'))
        if extra_fields.get('is_superuser') is not True:
            raise ValueError(_('Superuser must me is_superuser==True'))
        if extra_fields.get('is_active') is not True:
            raise ValueError(_('Superuser must me is_active==True'))
